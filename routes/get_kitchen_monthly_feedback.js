...
module.exports = (req, res) => {
    ...
    orderDAO.retrieve_monthly_feedback_kt(offset, kitchen_id)
        .then(feedbacks => {
            ...
            orderDAO.retrieve_monthly_feedback_is_positive()
                ...
                .catch(err => {
                    res.status(500).send({success:false, errMessage: "Fails at get_kitchen_monthly_feedback.js orderDAO.retrieve_monthly_feedback_is_positive ", error: err });
                });


        })
        .catch(err => {
            res.status(500).send({success:false, errMessage: "Fails at get_kitchen_monthly_feedback.js orderDAO.retrieve_monthly_feedback_kt ", error: err });
        });
